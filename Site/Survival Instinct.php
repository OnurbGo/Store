...
<body>
  <img class="banner" src="Imagens/Banner Survival.png" alt="Survival Instinct" title="Survival Instinct" />
  ...
  <main>
    ...
    <div class="jogocentro">
      <iframe class="jogocentro" width="90%" height="500" src="Jogos/Survival Instinct/index.html"
        title="Piratas"></iframe>
    </div>

    <div class="jogocentro">
      <a class="centroiframe" target="_blank" href="Jogos/Survival Instinct/index.html"><button class="botao-jogo">Jogo Em
          Tela Cheia</button></a>
    </div>
